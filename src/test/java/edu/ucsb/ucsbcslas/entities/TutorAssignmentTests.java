...
public class TutorAssignmentTests {
  ...
  public void test_toString() throws Exception {
    TutorAssignment ta1 = new TutorAssignment(1L, new Course(), new Tutor(), "190J");
    String expected = "{ id='1', course='Course[ id=null, number=null, quarter=null, instructorFirstName=null, instructorLastName=null, instructorEmail=null ]', tutor='{ id='null', firstName='null', lastName='null', email='null'}', assignmentType='190J'}";
