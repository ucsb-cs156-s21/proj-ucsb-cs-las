...
public class TutorAssignmentOfficeHourViewTest {
  ...
  public void testTutorAssignmentOfficeHourView_toString() throws Exception {
    ...
    String onlineOfficeHourExpected = "{ id='1', tutorAssignment='{ id='1', course='Course[ id=1, name=course 1, quarter=F20, instructorFirstName=fname, instructorLastName=lname, instructorEmail=email ]', tutor='{ id='1', firstName='Chris', lastName='Gaucho', email='cgaucho@ucsb.edu'}', assignmentType='TA'}', dayOfWeek='Tuesday', startTime='4:00 PM', endTime='6:00 PM', zoomRoomLink='https://ucsb.zoom.us/j/92714889391?pwd=dXlaVTFUS1NuNm5xL0NMUUFjRDVndz09', notes='Scott closes the room early sometimes but he will still be on slack!'}";
