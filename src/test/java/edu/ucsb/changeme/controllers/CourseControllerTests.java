...
public class CourseControllerTests {
  ...
  public void testGetCourses() throws Exception {
    ...
    expectedCourses.add(new Course(1L, "course 1", "F20", "fname", "lname", "email", "123456"));

    when(mockCourseRepository.findByUserId("123456")).thenReturn(expectedCourses);
    MvcResult response =
        mockMvc
    ...
    verify(mockCourseRepository, times(1)).findByUserId("123456");
  ...
  public void testSaveCourse() throws Exception {
    Course expectedCourse = new Course(1L, "course 1", "F20", "fname", "lname", "email", "123456");
    ...
    MvcResult response = mockMvc
        .perform(post("/api/courses").with(csrf()).contentType(MediaType.APPLICATION_JSON)
  ...
  public void testUpdateCourse_courseExists_updateValues() throws Exception {
    Course inputCourse = new Course(1L, "new course 1", "F20", "fname", "lname", "email", "123456");
    Course savedCourse = new Course(1L, "old course 1", "F20", "fname", "lname", "email", "123456");
    ...
    MvcResult response =
        mockMvc
            .perform(put("/api/courses/1").with(csrf()).contentType(MediaType.APPLICATION_JSON)
  ...
  public void testUpdateCourse_courseAtPathOwned_butTryingToOverwriteAnotherCourse() throws Exception {
    Course inputCourse = new Course(1L, "new course 1 trying to overwrite at id 1", "F20", "fname", "lname", "email", "123456");
    Course savedCourse = new Course(2L, "new course 1", "F20", "fname", "lname", "email", "123456");
    String body = objectMapper.writeValueAsString(inputCourse);
    when(mockCourseRepository.findById(any(Long.class))).thenReturn(Optional.of(savedCourse));
    mockMvc.perform(put("/api/courses/2").with(csrf()).contentType(MediaType.APPLICATION_JSON)
        .characterEncoding("utf-8").header(HttpHeaders.AUTHORIZATION, "Bearer " + userToken())
  ...
  public void testUpdateCourse_courseAtPathOwned_butTryingToInjectCourseForAnotherUser()
      throws Exception {
    Course inputCourse = new Course(1L, "new course 1 trying to inject to user id 654321", "F20", "fname", "lname", "email","654321");
    Course savedCourse = new Course(1L, "new course 1", "F20", "fname", "lname", "email","123456");
    String body = objectMapper.writeValueAsString(inputCourse);
    when(mockCourseRepository.findById(any(Long.class))).thenReturn(Optional.of(savedCourse));
    mockMvc.perform(put("/api/courses/1").with(csrf()).contentType(MediaType.APPLICATION_JSON)
        .characterEncoding("utf-8").header(HttpHeaders.AUTHORIZATION, "Bearer " + userToken())
  ...
  public void testUpdateCourse_courseAtPathNotOwned() throws Exception {
    Course inputCourse = new Course(1L, "new course 1", "F20", "fname", "lname", "email", "123456");
    Course savedCourse = new Course(2L, "new course 1", "F20", "fname", "lname", "email", "NOT YOURS");
    String body = objectMapper.writeValueAsString(inputCourse);
    when(mockCourseRepository.findById(any(Long.class))).thenReturn(Optional.of(savedCourse));
    mockMvc.perform(put("/api/courses/1").with(csrf()).contentType(MediaType.APPLICATION_JSON)
        .characterEncoding("utf-8").header(HttpHeaders.AUTHORIZATION, "Bearer " + userToken())
  ...
  public void testDeleteCourse_courseExists() throws Exception {
    Course expectedCourse = new Course(1L, "new course 1", "F20", "fname", "lname", "email", "123456");
  ...
  public void testDeleteCourse_courseNotOwned() throws Exception {
    Course expectedCourse = new Course(1L, "course 1", "F20", "fname", "lname", "email", "NOT YOURS");
