...
import CourseCSVButton from "main/components/Courses/CourseCSVButton";

jest.mock("swr");
jest.mock("@auth0/auth0-react");
jest.mock("main/utils/fetch");

describe("Course CSV Upload test", () => {
    const user = {
        name: "test user",
    };
    const courses = [
    ...
    test("upload file without crashing", () => {
        ...
        const { getByTestId, getByText } = render(<CourseCSVButton />);
