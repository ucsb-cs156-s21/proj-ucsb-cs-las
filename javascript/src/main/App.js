    ...
    <div className="App">
      ...
      <Container className="flex-grow-1 mt-5">
        <Switch>
          ...
          <AuthorizedRoute path="/admin/maintain" component={Admin} authorizedRoles={["admin"]} />
          <AuthorizedRoute path="/admin/logins" component={AdminLogins} authorizedRoles={["admin"]} />
